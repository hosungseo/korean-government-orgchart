...
- 직무등급, 임기제·별정직, 연구직·지도직·전문직·전문경력관·특정직, 한시·자율·총액인건비 메타데이터
...
| 연구·지도·전문·임기·별정·특정직 | `(연)`·`(지)`·`(전)`·`(임)`·`(별)`·`(특)` |
...
행정안전부·문화체육관광부·공정거래위원회 기구도와 2026년 중앙행정기관 취합본 61개 PPTX(185슬라이드), 별도 정부기구도 범례를 대조했습니다. 상세한 문형 사전과 조직통칙 검증 규칙은 다음 문서에 정리되어 있습니다.
